...
Version  : 24.12.1
Release  : 77
URL      : https://download.kde.org/stable/release-service/24.12.1/src/kdenetwork-filesharing-24.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/kdenetwork-filesharing-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/kdenetwork-filesharing-24.12.1.tar.xz.sig
...
%setup -q -n kdenetwork-filesharing-24.12.1
cd %{_builddir}/kdenetwork-filesharing-24.12.1
pushd ..
cp -a kdenetwork-filesharing-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736553232
mkdir -p clr-build
pushd clr-build
