...
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/kdenetwork-filesharing-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/kdenetwork-filesharing-24.02.1.tar.xz.sig
...
%prep
%setup -q -n kdenetwork-filesharing-24.02.1
cd %{_builddir}/kdenetwork-filesharing-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711087407
mkdir -p clr-build
pushd clr-build
