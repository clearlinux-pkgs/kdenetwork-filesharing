...
Version  : 19.08.3
Release  : 14
URL      : https://download.kde.org/stable/applications/19.08.3/src/kdenetwork-filesharing-19.08.3.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.3/src/kdenetwork-filesharing-19.08.3.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.3/src/kdenetwork-filesharing-19.08.3.tar.xz.sig
...
%prep
%setup -q -n kdenetwork-filesharing-19.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573166090
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdenetwork-filesharing-19.08.3/COPYING %{buildroot}/usr/share/package-licenses/kdenetwork-filesharing/3860f7708aae6a8ddfe8483263b2a5f29b83c975
cp %{_builddir}/kdenetwork-filesharing-19.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/kdenetwork-filesharing/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/kdenetwork-filesharing-19.08.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/kdenetwork-filesharing/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
