...
Version  : 19.04.2
Release  : 9
URL      : https://download.kde.org/stable/applications/19.04.2/src/kdenetwork-filesharing-19.04.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.2/src/kdenetwork-filesharing-19.04.2.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.2/src/kdenetwork-filesharing-19.04.2.tar.xz.sig
...
%prep
%setup -q -n kdenetwork-filesharing-19.04.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1559887416
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
